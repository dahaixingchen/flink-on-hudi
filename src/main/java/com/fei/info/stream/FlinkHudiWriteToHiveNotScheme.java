 ...
 **/
public class FlinkHudiWriteToHiveNotScheme {
...
//            genericRowData.setField(5, StringData.fromString("666666"));
            return genericRowData;
        });
        dStremMor.print();

        HoodiePipeline.Builder builderMor = HoodiePipeline.builder("flink_hudi_mor_stream_2515")
...
//                .column("age VARCHAR(10)")
                ...
                //添加参数
                .option(FlinkOptions.PATH.key(), "/user/chengfei/hudi-flink-mor-stream15")
//                .option(FlinkOptions.TABLE_TYPE.key(), HoodieTableType.COPY_ON_WRITE.name())
                ...
                .option(FlinkOptions.HIVE_SYNC_TABLE.key(), "flink_hudi_mor_stream_2515")

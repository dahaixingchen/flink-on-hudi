...
public class FlinkHudiWriteToHive {
    public static void main(String[] args) throws Exception {
        ...
        HoodiePipeline.Builder builder = HoodiePipeline.builder("flink_hudi_stream")
                ...
                .option(FlinkOptions.PRECOMBINE_FIELD.key(), "pt") //当主键冲突的时候以什么字段的最大值为标准
        //自动开启创建表

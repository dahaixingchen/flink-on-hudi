 ...
 **/
public class FlinkHudiWriteToHiveChangeScheme {
    public static void main(String[] args) throws Exception {
        ...
        HoodiePipeline.Builder builderMor = HoodiePipeline.builder("flink_hudi_mor_stream_2611")
                ...
                .partition("pt")
                .pk("uuid")
                .option(FlinkOptions.PATH.key(), "/user/chengfei/hudi-flink-mor-stream2611")
//                .option(FlinkOptions.TABLE_TYPE.key(), HoodieTableType.COPY_ON_WRITE.name())
                ...
                .option(FlinkOptions.HIVE_SYNC_TABLE.key(), "flink_hudi_mor_stream_2611")
